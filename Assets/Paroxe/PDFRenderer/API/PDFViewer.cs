...
namespace Paroxe.PdfRenderer
{
    ...
    public class PDFViewer : UIBehaviour, IPDFDevice, IPDFColoredRectListProvider
    {
        ...
        public bool m_AllowedToPinchZoom;
        private PDFViewerHelper m_PDFViewerHelper;
...
#pragma warning restore 414
        ...
        public float ScaleFactorMenu;
		public ZoomDisplay m_ZoomDisplayOpened;
		public ZoomDisplay m_ZoomDisplayClosed;
        ...
        {
            m_ContentCanvas = m_Internal.m_ContentCanvas;
        }
            ...
            set
            {
                if (m_ShowTopBar != value)
                {
                    ...
                    else
                    {
                        ...
                        m_Internal.m_TopPanel.sizeDelta = new Vector2(0.0f, 121f);

                        m_Internal.m_Viewport.offsetMax = new Vector2(m_Internal.m_Viewport.offsetMax.x, -121.0f);
                        m_Internal.m_VerticalScrollBar.offsetMax =
                            new Vector2(m_Internal.m_VerticalScrollBar.offsetMax.x, -120.0f);

                        if (m_Internal.m_LeftPanel != null)
                        {
                            (m_Internal.m_LeftPanel.transform as RectTransform).sizeDelta =
                                new Vector2((m_Internal.m_LeftPanel.transform as RectTransform).sizeDelta.x, -120.0f);
                        }
                    }
                }
            }
                ...
                case PageFittingType.ViewerHeight:
                    {
					    ...
					    m_ZoomToGo = firstPageHeight / viewportHeight;
        ...
        public Vector2 GetDocumentSize()
        {
        ...
        private void ProcessPinchZoom()
        {
            ...
            if (validTouchCount >= 2 && !m_Internal.m_ContentCanvas.enabled)
			{
                if (m_AllowedToPinchZoom == true)
                {
                    foreach (Touch item in Input.touches)
                    {
                        if ((m_Internal.m_TopPanelRect.rect.Contains(item.position)) || (m_Internal.m_LeftPanelRect.rect.Contains(item.position)))
                        {
        ...
        protected override void Start()
        {
            ...
            ScaleFactorMenu = 1.1f;

            m_PDFViewerHelper = GetComponent<PDFViewerHelper>();
            m_AllowedToPinchZoom = true;
        ...
        private void LateUpdate()
        {
            ...
            if (zoomHasChanged)
            {
                ...
                m_PDFViewerHelper.changeZoom(oldDocumentSize, GetDocumentSize(), m_ZoomFactor);
        ...
        private void UpdateScrollBarVisibility()
        {
            ...
            {
                m_Internal.m_Viewport.offsetMax = new Vector2(0, m_Internal.m_Viewport.offsetMax.y);
            ...
            if (hScrollVisible && vScrollVisible)
            {
                ...
                m_Internal.m_HorizontalScrollBar.offsetMax = new Vector2(0f,
        ...
        public void UpdateRenderer(float f)
        {
            m_UpdateChangeDelay = f;
        }
