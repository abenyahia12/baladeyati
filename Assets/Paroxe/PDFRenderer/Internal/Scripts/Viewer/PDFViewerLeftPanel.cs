...
namespace Paroxe.PdfRenderer.Internal.Viewer
{
    public class PDFViewerLeftPanel : UIBehaviour
    {
        ...
        public Image m_BookmarksTabImage;
        public Sprite m_ClosedTabSprite;
		public RectTransform m_ArrowImageRect;
        ...
        public Image m_ThumbnailsTabImage;
        ...
        private void UpdateGraphics()
        {
			...
			if (m_Opened)
			{
				m_ArrowImageRect.rotation = new Quaternion(m_ArrowImageRect.rotation.x, m_ArrowImageRect.rotation.y, m_ArrowImageRect.rotation.z * -1, m_ArrowImageRect.rotation.w);
			}
			else
			{
				m_ArrowImageRect.rotation = new Quaternion(m_ArrowImageRect.rotation.x, m_ArrowImageRect.rotation.y, m_ArrowImageRect.rotation.z * -1, m_ArrowImageRect.rotation.w);
